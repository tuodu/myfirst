...
(function (q) {
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            ...
            if (!c)return [];
            var j = [], k = b.data.key.children, m = (d ? d : h.getRoot(b))[k], r, Q;
            if (!m || e >= m.length)e = -1;
            for (var t = 0, q = c.length; t < q; t++) {
                var o = c[t];
                g && (r = (e === 0 || m.length == c.length) && t == 0, Q = e < 0 && t == c.length - 1, h.initNode(b, a, o, d, r, Q, f), h.addNodeCache(b, o));
                r = [];
                o[k] && o[k].length > 0 && (r = i.appendNodes(b, a + 1, o[k], o, -1, g, f && o.open));
                f && (i.makeDOMNodeMainBefore(j, b, o), i.makeDOMNodeLine(j, b, o), h.getBeforeA(b,
                    o, j), i.makeDOMNodeNameBefore(j, b, o), h.getInnerBeforeA(b, o, j), i.makeDOMNodeIcon(j, b, o), h.getInnerAfterA(b, o, j), i.makeDOMNodeNameAfter(j, b, o), h.getAfterA(b, o, j), o.isParent && o.open && i.makeUlHtml(b, o, j, r.join("")), i.makeDOMNodeMainAfter(j, b, o), h.addCreatedNode(b, o))
            }
            return j
            ...
            b && (h.initCache(b), h.initRoot(b), m.unbindTree(b), m.unbindEvent(b), b.treeObj.empty(), delete s[b.treeId])
            ...
            c = {
                setting: d, addNodes: function (a, b, c, f) {
                    ...
                    !j.canAsync(d, a) && c ? i.expandCollapseSonNode(d,
                        a, b, !0, m) : (a.open = !b, i.switchNode(this.setting, a), m());
                    return b
                }, getNodes: function () {
                    return h.getNodes(d)
                ...
                reAsyncChildNodes: function (a, b, c) {
                    ...
                    if (a && j.uCanDo(d)) {
                        ...
                        if (a.parentTId)i.expandCollapseParentNode(d,
                            a.getParentNode(), !0, !1, f); else if (!c)try {
                            k(a, d).focus().blur()
                        } catch (h) {
                        }
                        i.selectNode(d, a, b)
